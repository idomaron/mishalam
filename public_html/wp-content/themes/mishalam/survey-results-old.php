...
<div class="temp-answers">
<?php
$answers = GetAnswers();
if($answers): echo '<ul>'; foreach($answers as $answer):
$users = UsersVotedToAnswer($answer->meta_id);
?>
<li>הצביעו <?php echo $answer->meta_value ?>: <?php echo sizeof($users)?></li>
<?php
endforeach; echo '</ul>'; endif;
?>
</div>