...
<!--<textarea style="direction:ltr;text-align:left;width: 100%;height: 300px;">
<?php //var_dump($_POST) ?>
		...
		<div id="content" class="site-content" role="main">
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> >
                 ...
                 <?php
                // the following is replaced with shortcode 
				/*
					...
					<div class="edittop">
                    	<div class="profilesingle">
                            ...
                            <div class="rightboxprofile"><input name="a" type="text" class="fieldpro" /></div>
                        </div>
                        <div class="profilesingle">
                        	<div class="nametxt">*שם משפחה</div>
                            <div class="rightboxprofile"><input name="b" type="text" class="fieldpro" /></div>
                        </div>
                        <div class="profilesingle">
                        	<div class="nametxt">דוא”ל</div>
                            <div class="rightboxprofile"><input name="c" type="text" class="fieldpro" /></div>
                        </div>
                    </div>
                    ...
                    <div class="profilesingleselect">
                            ...
                            <select name="d" class="country_id">
                            	<option>Male</option>
                    ...
                    <div class="profilesingleselect">
                            ...
                            <div class="rightboxprofileselect">
                            <select name="e" class="country_id">
                    ...
                    <div class="profilesingleselect">
                            ...
                            <div class="rightboxprofileselect">
                            <select name="f" class="country_id">
                            	<option>lorem ip</option>
                                <option>lorem ip</option>
                                <option>lorem ip</option>
                                <option>lorem ip</option>
                    ...
                    <div class="profilesingleselectbut">
                    	<div class="buttonareapro">
                            ...
                            <div class=""><input name="" class="bluebut" value="שמירה" type="submit" /></div>
                        </div>
                    </div>
                    </div>
...
$(function() {
	$("div#wpmem_reg select").selectbox();
});
</script>
