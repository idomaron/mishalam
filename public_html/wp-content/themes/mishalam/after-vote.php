...
<div class="innerpage4">
	<div class="content-index-inner4">
    ...
    בסקרים</div>
                ...
                <div class="afterfacebook2">
                	<div class="innerbox">
                    	<div class="votetxt">הצבעתך נקלטה בהצלחה!</div>
                    </div>
                </div>
                <div class="backroundimgareavotedis">
                    	<div class="lefttxtvote">תוצאות<br />
ביניים</div>                    	
                    </div>
                <div class="grayarea2">
                	<div class="innerbox">
                    	<div class="retioportionvote">
                            <div class="tophead" style="color:#ffffff;">סיום הסקר והצגת התוצאות בעוד</div>
                            <div class=""><img src="<?php bloginfo( 'template_url' ); ?>/images/ratioicons.png"></div>
                            <div class="txtvoteof"><a href="#">לשינוי הצבעתך לחץ כאן</a></div>
                        </div>
                    </div>
                </div>
                <div class="colerbuletarea2">
                	<ul>
                    	<li>
                ...
                <div class="graparea2">
                	<div class="graph"><img src="<?php bloginfo( 'template_url' ); ?>/images/graph.jpg" alt=""/></div>
                    <div class="backroundimgareavote">
                    	<div class="lefttxtvote">תוצאות<br />
ביניים</div>                    	
                    </div>
                </div>
